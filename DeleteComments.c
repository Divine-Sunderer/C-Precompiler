...
int deleteComments(FILE *input, FILE *output, FILE *statistiche, char* nome_input, char* nome_output, bool checkFinale) {
  ...
  if(!input) input = fopen(nome_input,"r+");
  ...
  if (checkFinale) printf("funzione deleteComments2 eseguita con successo\n");
  else printf("funzione deleteComments1 eseguita con successo\n");
